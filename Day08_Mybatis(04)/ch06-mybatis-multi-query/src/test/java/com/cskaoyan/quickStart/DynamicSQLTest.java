...
import com.cskaoyan.dto.UserDetail;
...
//     分次查询
    ...
    // 一对一分次查询
    @Test
    public void testSelectOne2One() throws InterruptedException {

        User user = userMapper.selectUserWithDetailById2(10);
...
//        System.out.println(user);
    ...
    public void testSelectClass(){
        ...
        Clazz clazz = clazzMapper.selectClazzWithStudentsByName2("二班");
    ...
    public void testSelectStudent(){
        ...
        Student student = studentMapper.selectStudentWithCoursesByName2("张飞");
